...
static unsigned long psu_pll_init_data(void)
{
	...
	psu_mask_write(0xFD1A002C, 0x00717F00U, 0x00015400U);
...
static unsigned long psu_clock_init_data(void)
{
	...
	psu_mask_write(0xFD1A0080, 0x00003F07U, 0x00000800U);
...
static unsigned long psu_ddr_init_data(void)
{
	...
	psu_mask_write(0xFD070024, 0xFFFFFFFFU, 0x001AB3F0U);
	psu_mask_write(0xFD070030, 0x0000007FU, 0x00000000U);
	psu_mask_write(0xFD070034, 0x00FFFF1FU, 0x00402C10U);
	psu_mask_write(0xFD070050, 0x00F1F1F4U, 0x00210000U);
	psu_mask_write(0xFD070054, 0x0FFF0FFFU, 0x00000000U);
	psu_mask_write(0xFD070060, 0x00000073U, 0x00000001U);
	psu_mask_write(0xFD070064, 0x0FFF83FFU, 0x00058020U);
	psu_mask_write(0xFD070070, 0x00000017U, 0x00000010U);
	psu_mask_write(0xFD070074, 0x00000003U, 0x00000000U);
	psu_mask_write(0xFD0700C4, 0x3F000391U, 0x10000200U);
	psu_mask_write(0xFD0700C8, 0x01FF1F3FU, 0x0030051FU);
	psu_mask_write(0xFD0700D0, 0xC3FF0FFFU, 0x00020157U);
	psu_mask_write(0xFD0700D4, 0x01FF7F0FU, 0x00240000U);
	psu_mask_write(0xFD0700D8, 0x0000FF0FU, 0x00000C05U);
	psu_mask_write(0xFD0700DC, 0xFFFFFFFFU, 0x00140009U);
	...
	psu_mask_write(0xFD070100, 0x7F3F7F3FU, 0x0B070108U);
	psu_mask_write(0xFD070104, 0x001F1F7FU, 0x0003040CU);
	psu_mask_write(0xFD070108, 0x3F3F3F3FU, 0x0305130CU);
	psu_mask_write(0xFD07010C, 0x3FF3F3FFU, 0x00A05000U);
	psu_mask_write(0xFD070110, 0x1F0F0F1FU, 0x0A040307U);
	psu_mask_write(0xFD070114, 0x0F0F3F1FU, 0x01020303U);
	psu_mask_write(0xFD070118, 0x0F0F000FU, 0x01010004U);
	psu_mask_write(0xFD07011C, 0x00000F0FU, 0x00000201U);
	psu_mask_write(0xFD070120, 0x7F7F7F7FU, 0x02020303U);
	psu_mask_write(0xFD070124, 0x40070F3FU, 0x0004040DU);
	psu_mask_write(0xFD07012C, 0x7F1F031FU, 0x440C011CU);
	psu_mask_write(0xFD070130, 0x00030F1FU, 0x00020608U);
	psu_mask_write(0xFD070180, 0xF7FF03FFU, 0x80AF0006U);
	psu_mask_write(0xFD070184, 0x3FFFFFFFU, 0x0092160EU);
	psu_mask_write(0xFD070190, 0x1FBFBF3FU, 0x04878204U);
	...
	psu_mask_write(0xFD0701B4, 0x00003F3FU, 0x00000502U);
	...
	psu_mask_write(0xFD080018, 0xFFFFFFFFU, 0x00F006C0U);
	psu_mask_write(0xFD08001C, 0xFFFFFFFFU, 0x55AA5480U);
	psu_mask_write(0xFD080024, 0xFFFFFFFFU, 0x010100F4U);
	psu_mask_write(0xFD080040, 0xFFFFFFFFU, 0x15E0AF10U);
	psu_mask_write(0xFD080044, 0xFFFFFFFFU, 0x445C0627U);
	psu_mask_write(0xFD080068, 0xFFFFFFFFU, 0x07146000U);
	...
	psu_mask_write(0xFD080110, 0xFFFFFFFFU, 0x04100D08U);
	psu_mask_write(0xFD080114, 0xFFFFFFFFU, 0x280E070BU);
	psu_mask_write(0xFD080118, 0xFFFFFFFFU, 0x000F0042U);
	psu_mask_write(0xFD08011C, 0xFFFFFFFFU, 0x82000501U);
	psu_mask_write(0xFD080120, 0xFFFFFFFFU, 0x003F2B08U);
	psu_mask_write(0xFD080124, 0xFFFFFFFFU, 0x00171308U);
	psu_mask_write(0xFD080128, 0xFFFFFFFFU, 0x0000060AU);
	...
	psu_mask_write(0xFD080184, 0xFFFFFFFFU, 0x00000014U);
	psu_mask_write(0xFD080188, 0xFFFFFFFFU, 0x00000009U);
	...
	psu_mask_write(0xFD0801B8, 0xFFFFFFFFU, 0x0000006FU);
	...
	psu_mask_write(0xFD080528, 0xFFFFFFFFU, 0xF10329EFU);
	...
	psu_mask_write(0xFD080680, 0xFFFFFFFFU, 0x0088EC58U);
	...
	psu_mask_write(0xFD081484, 0xFFFFFFFFU, 0x27146000U);
	...
	psu_mask_write(0xFD0814C4, 0xFFFFFFFFU, 0x27146000U);
	...
	psu_mask_write(0xFD081504, 0xFFFFFFFFU, 0x27146000U);
...
static unsigned long psu_mio_init_data(void)
{
	...
	psu_mask_write(0xFF180028, 0x000000FEU, 0x000000C0U);
	psu_mask_write(0xFF18002C, 0x000000FEU, 0x000000C0U);
	...
	psu_mask_write(0xFF180048, 0x000000FEU, 0x00000040U);
	psu_mask_write(0xFF18004C, 0x000000FEU, 0x00000040U);
	...
	psu_mask_write(0xFF180204, 0xFFFFFFFFU, 0x51000400U);
	...
	psu_mask_write(0xFF180144, 0x029E1FFFU, 0x029E1FFFU);
	psu_mask_write(0xFF180148, 0x03FFFFFFU, 0x029E1FFFU);
...
{
	psu_mask_write(0xFD1A0100, 0x000F8044U, 0x00000000U);
	...
	psu_mask_write(0xFF180320, 0x00003384U, 0x00000080U);
...
static unsigned long psu_serdes_init_data(void)
{
	psu_mask_write(0xFD410000, 0x0000001FU, 0x0000000DU);
	psu_mask_write(0xFD410004, 0x0000001FU, 0x0000000DU);
	psu_mask_write(0xFD410008, 0x0000001FU, 0x00000009U);
